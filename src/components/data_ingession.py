...
class DataIngession:
    ...
    def initiate_data_ingession(self):
        logging.info("Data Ingession Initiated")
        try:
            ...
            train_set,test_set=train_test_split(df,test_size=0.25,random_state=24)
            ...
            logging.info("Immigation of the data is completed")
